...
<body>
	...
	<!-- M0DAL-MANAGE -->
	<div class="modal fade" id="modalManage" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				...
				<div class="join-modal">
					<form id="box-projectadd">
						...
						<div class="add-left">
							<div class="project-adding">当前人数：</div>
							<div class="person-number">4/10</div>
						</div>

						<div class="join-box">
							<div class="project-adding">申请加入的人:</div>
							<ul>
								<li class="join-man"><a href="#">鸡汁汇汇<img
										src="../../img/avater.png" class="img-circle"></a> <a
									href="#" type="button" class="btn-pass">通过</a></li>
								<li class="join-man"><a href="#">鸡汁汇汇<img
										src="../../img/avater.png" class="img-circle"></a> <a
									href="#" type="button" class="btn-pass">通过</a></li>
								<li class="join-man"><a href="#">鸡汁汇汇<img
								...
								<tbody>
									<tr>
										...
										<td><a href="#" type="button" data-toggle="modal"
											data-target="#modalManage">编辑</a></td>
										<th><a>退出</a></th>
									</tr>
									<tr>
										<td><a>Project2</a></td>
