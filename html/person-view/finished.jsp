...
<div id="content">
    ...
    <div class="alert alert-danger" role="alert" style="margin-bottom: 0px;">
        <strong>亲爱的用户</strong> 你还没有完善你的个人信息，请点击<a href="edit.jsp">这里</a>完善个人信息
    </div>
    <%}%>
    <div class="container" style="padding-top:20px;">
		<div class="row">
			...
			<div class="col-md-4">
				<h3>个人信息<span style="float:right"><small><a href="edit.jsp">编辑</a></small></span></h3>
